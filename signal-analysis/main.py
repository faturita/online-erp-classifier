...
splits = len(experiences_list) / 2
splits = int(splits)
print('Size : %d, Split at %d' % (len(experiences_list) , splits))

train_experiences = experiences_list[:splits]
test_experiences = experiences_list[splits:]

classifier = trainer.train_classifier(train_experiences, "classifiers.joblib", n=10)
classification = tester.test_classifier("classifiers.joblib", test_experiences, n=10)
